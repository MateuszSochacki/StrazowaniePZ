...
//                System.out.println(t1); Nowo wybrany
                CategoryEntity category = categoryRepository.findByName(t1);
                List <CategoryEntity> categoryList = new ArrayList<>();
                categoryList.add(category);

//                List<MovieHasCategoryEntity> movieListAfterFilterById = movieHasCategoryRepository.
//                        findAll().stream().filter(movieHasCategoryEntity -> movieHasCategoryEntity.
//                        getCategoryIdCategory().equals(category.getIdCategory())).collect(Collectors.toList());
...
//                }
                List <MovieEntity> movieEntities = movieRepository.findByCategoryEntities(categoryList);
...
//            loader.setLocation(getClass().getResource("/scene/ChooseMovie.fxml"));
